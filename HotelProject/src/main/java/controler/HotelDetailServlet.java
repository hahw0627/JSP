...
public class HotelDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        HotelDTO selectedHotel = null;
        if (hotelId != null && !hotelId.isEmpty()) {
            List<HotelDTO> hotels = getMockHotelData();
            // hotelId로 숙소 찾기
            Optional<HotelDTO> foundHotel = hotels.stream()
        ...
        if (selectedHotel != null) {
            ...
            System.out.println("HotelDetailServlet: Hotel not found for ID: " + hotelId); // 로그 추가
        }
